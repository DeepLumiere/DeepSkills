...
flowchart TD
    ...
    Root --> F["Faster Decisions"]
    F --> F1["Current live metrics vs delayed quarterly reviews"]
    F --> F2["Sub-second anomaly detection"]
    F --> F3["Dynamic pricing and resource reallocation"]
    Root --> L["Lower Risk"]
    L --> L1["Early detection of fraud patterns"]
    L --> L2["Predictive maintenance preventing downtime"]
    L --> L3["Proactive churn identification"]
    Root --> C["Competitive Edge"]
    C --> C1["Precision performance tracking"]
    C --> C2["Targeted personalized customer experiences"]
    C --> C3["Lean resource optimization vs competitor guesswork"]
```
...
flowchart TD
    subgraph Structured Format
        Q2["Internal Structured<br/>ERP, SQL sales tables, HR databases"]
        Q1["External Structured<br/>Market reports, Competitor pricing feeds"]
    end
    subgraph Unstructured Format
        Q3["Internal Unstructured<br/>Employee emails, Customer call logs"]
        Q4["External Unstructured<br/>Social media posts, Product reviews"]
    end
    Q2 ~~~ Q1
    Q3 ~~~ Q4
```
